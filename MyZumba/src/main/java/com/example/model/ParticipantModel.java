...
public class ParticipantModel {
	...
	private String participant_dob;
	...
	public String getParticipant_dob() {
		return participant_dob;
	}
	public void setParticipant_dob(String participant_dob) {
		this.participant_dob = participant_dob;
	}
